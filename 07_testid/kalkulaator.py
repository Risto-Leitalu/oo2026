...
class Kalkulaator:
    ...
    def siinus(self):
        self.sisu = str(round(math.sin(int(self.sisu)), 2))
        

    def koosiinus(self):
        self.sisu =str(round(math.cos(int(self.sisu)), 2))
        

    def tangents(self):
        self.sisu = str(round(math.tan(int(self.sisu)), 2))
    ...
    def summa(self):
        if self.Liida == True:
            self.sisu = str(int(int(self.temp) + int(self.sisu)))
            self.Liida = False
            
        elif self.Lahuta == True:
            self.sisu = str(int(int(self.temp1) - int(self.sisu)))
            self.Lahuta = False
            
        elif self.Korruta == True:
            self.sisu = str(int(int(self.temp2) * int(self.sisu)))
            self.Korruta = False
            
        elif self.Jaga == True:
            self.sisu = str(int(int(self.temp3) / int(self.sisu)))
            self.Jaga = False
...
class TestKalkulaator(unittest.TestCase):
    ...
    def test_sinus(self):
        ...
        self.k.siinus()
        self.k.summa()
        self.assertEqual(self.k.ekraan(), "0.89")
        
    def test_koosiinus(self):
        self.k.puhasta()
        self.k.vajutus("60")
        self.k.koosiinus()
        self.k.summa()
        self.assertEqual(self.k.ekraan(), "-0.95")
